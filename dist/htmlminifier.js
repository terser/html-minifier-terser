...
import require$$2 from 'relateurl';
import require$$3 from 'terser';
...
const createMapFromString$1 = utils$1.createMapFromString;
const replaceAsync = utils$1.replaceAsync;
...
htmlparser.HTMLtoXML = function (html) {
  ...
  const parser = new HTMLParser$1(html, {
...
const CleanCSS = require$$0;
const { decode } = require$$1;
const RelateUrl = require$$2;
const Terser = require$$3;
